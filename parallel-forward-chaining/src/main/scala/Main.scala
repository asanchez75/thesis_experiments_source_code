...
// parquet -> delta
/////////////////////////////////////////////////////////////////////////////////////
//val df = spark.read.parquet("/usr/local/src/node10")
//val db =  df.where("g in ('http://ontosides', 'http://ontosides/missing')")
//db.write.format("delta").mode("overwrite").partitionBy("g").save("hdfs://hadoop-namenode/node10")
/////////////////////////////////////////////////////////////////////////////////////

val df = spark.read.format("delta").load("hdfs://hadoop-namenode/node880")
df.printSchema()
df.show(10, false)
df.count()
...
val fq1 = Future {
    ...
    //spark.time(df1.write.format("delta").mode("append").save("hdfs://hadoop-namenode/rules/g=rule1"))
...
rule1.write.format("delta").mode("append").save("hdfs://hadoop-namenode/node10")
rule2.write.format("delta").mode("append").save("hdfs://hadoop-namenode/node10")
rule3.write.format("delta").mode("append").save("hdfs://hadoop-namenode/node10")
rule9.write.format("delta").mode("append").save("hdfs://hadoop-namenode/node10")
rule10.write.format("delta").mode("append").save("hdfs://hadoop-namenode/node10")
...
rule4.write.format("delta").mode("append").save("hdfs://hadoop-namenode/node10")
rule5.write.format("delta").mode("append").save("hdfs://hadoop-namenode/node10")
rule6.write.format("delta").mode("append").save("hdfs://hadoop-namenode/node10")
rule7.write.format("delta").mode("append").save("hdfs://hadoop-namenode/node10")
...
rule8.write.format("delta").mode("append").save("hdfs://hadoop-namenode/node10")
rule12.write.format("delta").mode("append").save("hdfs://hadoop-namenode/node10")
rule11.write.format("delta").mode("append").save("hdfs://hadoop-namenode/node10")
...
rule13.write.format("delta").mode("append").save("hdfs://hadoop-namenode/node10")
rule14.write.format("delta").mode("append").save("hdfs://hadoop-namenode/node10")
rule15.write.format("delta").mode("append").save("hdfs://hadoop-namenode/node10")
rule16.write.format("delta").mode("append").save("hdfs://hadoop-namenode/node10")
rule17.write.format("delta").mode("append").save("hdfs://hadoop-namenode/node10")
rule18.write.format("delta").mode("append").save("hdfs://hadoop-namenode/node10")
